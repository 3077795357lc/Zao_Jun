 ...
 * Size: 32 px
 * Bpp: 4
 * Opts: --no-compress --bpp 4 --size 32 --format lvgl --font assets/fonts/fa-solid-900.ttf -r 0xf0eb -r 0xf2dc -r 0xf2c9 -r 0xf043 -r 0xf013 -r 0xf15c -r 0xf030 -r 0xf001 -r 0xf017 -r 0xf015 --lv-include lvgl.h --lv-font-name icons_32 -o assets/fonts/icons_32.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xff, 0xff, 0xff, 0x0, 0xf7, 0x0, 0x0, 0x0,
    ...
    0xff, 0xff, 0xff, 0x0, 0xff, 0xff, 0xff, 0xf7,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 528, .adv_w = 512, .box_w = 32, .box_h = 32, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 1040, .adv_w = 576, .box_w = 37, .box_h = 33, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 1651, .adv_w = 512, .box_w = 32, .box_h = 32, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 2163, .adv_w = 512, .box_w = 32, .box_h = 28, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 2611, .adv_w = 384, .box_w = 24, .box_h = 32, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 2995, .adv_w = 384, .box_w = 22, .box_h = 32, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 3347, .adv_w = 384, .box_w = 24, .box_h = 32, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 3731, .adv_w = 320, .box_w = 18, .box_h = 32, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 4019, .adv_w = 448, .box_w = 30, .box_h = 32, .ofs_x = -1, .ofs_y = -4}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x12, 0x14, 0x16, 0x2f, 0x42, 0xea, 0x15b,
    0x2c8, 0x2db
};
...
{
    {
        .range_start = 61441, .range_length = 732, .glyph_id_start = 1,
